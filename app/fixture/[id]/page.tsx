...
export default async function FixturePage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const winProb = Math.round(prediction.homeWinProb * 100);
    const drawProb = Math.round(prediction.drawProb * 100);
    const lossProb = Math.round(prediction.awayWinProb * 100);
